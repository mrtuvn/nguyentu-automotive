...
import Themes from "@/constrants/themes";
...
export default function Header() {
  return (
    <>
      <div className="text-gray flex justify-between items-center gap-5 w-full">
        <Image
          src="/vercel.svg"
          alt="Vercel Logo"
        ...
        <div className="flex items-center gap-6 mr-auto w-full pr-4 flex-[80%]">
          <NavLinks />

          <div className="flex items-center gap-2 w-[20%] ml-auto">
            <Themes />
